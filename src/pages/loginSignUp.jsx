    ...
    return (
        <div className='loginsignup'>
            <div className="loginsignup-container">
                ...
                {state==="Sign Up"?<p name className="loginsignup-login">Already have an account? <span onClick={()=>{setState("Login")}}>Login Here</span></p>:<p className="loginsignup-login">Create an account? <span onClick={()=>{setState("Sign Up")}}>Click Here</span></p>}
